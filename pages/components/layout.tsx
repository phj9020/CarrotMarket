        ...
        <div>
            ...
            {hasTabBar ?
                <nav className="fixed bottom-0 flex items-center justify-around w-full max-w-xl py-3 text-gray-800 bg-white border-t">
                    <Link href="/">
                        <a className={cls(router.pathname == "/" ? "text-orange-500" : "null", "flex flex-col items-center justify-center")}>
                    ...
                    <Link href="/community">
                        <a className={cls(router.pathname == "/community" ? "text-orange-500" : "null", "flex flex-col items-center justify-center")}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    ...
                    <Link href="/chats">
                        <a className={cls(router.pathname == "/chats" ? "text-orange-500" : "null", "flex flex-col items-center justify-center")}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    ...
                    <Link href="/live">
                        <a className={cls(router.pathname == "/live" ? "text-orange-500" : "null", "flex flex-col items-center justify-center")}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    ...
                    <Link href="/profile">
                        <a className={cls(router.pathname == "/profile" ? "text-orange-500" : "null", "flex flex-col items-center justify-center")}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
