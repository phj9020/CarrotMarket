            ...
            <div className="px-4 py-10">
                <div className="flex items-center space-x-3">
                    ...
                    <div className="flex flex-col">
                        <span className="font-medium text-gray-900">phj9020</span>
                        <Link href="/profile/edit">
                            <a>
                                <span className="text-sm text-gray-700">프로필 편집 &rarr;</span>
                            </a>
                        </Link>
                    </div>
                </div>
                    ...
                    <Link href="/profile/sold">
                        <a>
                            <div className="flex flex-col items-center">
                                ...
                                <span className="mt-2 text-sm font-medium text-gray-700">판매 내역</span>
                            </div>
                        </a>
                    </Link>
                    <Link href="/profile/bought">
                        <a>
                            <div className="flex flex-col items-center">
                                ...
                                <span className="mt-2 text-sm font-medium text-gray-700">구매 내역</span>
                            </div>
                        </a>
                    </Link>
                    <Link href="/profile/interest">
                        <a>
                            <div className="flex flex-col items-center">
                                ...
                                <span className="mt-2 text-sm font-medium text-gray-700 ">관심 목록</span>
                            </div>
                        </a>
                    </Link>
                </div>
                <div className="mt-12">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h4 className="text-sm font-bold text-gray-900">한진</h4>
