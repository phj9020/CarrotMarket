        ...
        <div className="mt-8">
            ...
            <div className="mt-1">
                ...
                <div className="flex rounded-md shadow-sm">
                    ...
                    <input type="tel" required  className="w-full px-3 py-2 rounded-l-none placeholder-gray-400 border border-gray-300 rounded-md shadow-sm appearance-none focus:outline-none focus:ring-orange-500 focus:border-orange-500" />
                </div>
                ) : null}
            </div>
            ...
            <div className="mt-8">
                <div className="relative">
                    ...
                    <div className="relative -top-3 text-center">
                        <span className="bg-white px-2 text-sm text-gray-500">또는 간편 로그인</span>
                    </div>
                </div>
